...
| --- | --- | --- |
| <ul> <li> **Chiave SDK:**<br/> [Streamtype](./audio-video-parameters.md#create-media-object) </li> <li> **Chiave API:**<br/> media. streamtype </li> <li> **Richiesto:**<br/> Sì </li> <li> **Tipo:**<br/> stringa </li> <li> **Inviato con:**<br/> Inizio file multimediali, Chiudi file multimediali </li> <li> **Min. SDK Version:** 2.2 <br/><br/>Available in [Media Collection API Overview](../media-collection-api/mc-api-overview.md) or [Download SDKs - Versions 2.2](../sdk-implement/download-sdks.md).  </li>  <li> **Valore di esempio:**<br/> " video " </li> <li> **Descrizione:**<br/> Identifica il tipo di flusso. I valori validi sono "audio", "video" e "". <br/><br/>[Segmenti](../metrics-and-metadata/segments.md): <br/><br/>Streamtype "All" - Segmenta tutti i dati del flusso multimediale. <br/> **Regola:** Contenuto (ID) esiste <br/><br/>streamtype "Audio" - Segmento tutti i dati del flusso audio. <br/>**Regola:** Content (ID) esiste AND Stream Type = audio <br/><br/>streamtype "Video" - Segmenta tutti i dati del flusso video. <br/>**Regola:** Content (ID) esiste AND Stream Type = video <br/><br/> **Data di rilascio: 09/13/18** </li></ul> | <ul> <li> **Adobe Analytics:**<br/> (a. media. streamtype) </li> <li> **Heartbeats:**<br/> (s: meta:<br/>a. media. streamtype) </li> </ul> | <ul> <li> **Disponibile:**<br/> Sì </li> <li> **Variabile riservata:**<br/> Evar </li> <li> **Scadenza:**<br/> ALLA VISITA </li> <li> **Nome rapporto:**<br/> Contenuto </li> <li> **Dati contestuali:**<br/> (a. media. streamtype) </li> <li> **Feed dati:**<br/> videostreamtype </li> <li> **Audience Manager:**<br/> (c_ contextdata.<br/>a. media. streamtype) </li> </ul> |
