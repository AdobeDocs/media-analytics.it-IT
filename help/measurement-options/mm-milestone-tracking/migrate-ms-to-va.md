...
| Pietra miliare | Sintassi pietra miliare | Media  Analytics | Sintassi Analytics  Media |
| --- | --- | --- | --- |
...
| CPM | `CPM`: CPM o CPM crittografato (con il prefisso &quot;~&quot;) che si applica a questa riproduzione. | N/D | Per impostazione predefinita, non è disponibile in Media  Analytics. |
