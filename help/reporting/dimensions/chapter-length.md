...
La lunghezza del capitolo viene impostata dal lettore a ogni evento `media.chapterStart`.
...
| Customer Journey Analytics | [`mediaReporting.chapterDetails.length`](https://experienceleague.adobe.com/it/docs/experience-platform/xdm/data-types/chapter-details-reporting) |
...
Ogni elemento rappresenta il valore di lunghezza intero, in secondi, riportato su `media.chapterStart`.
