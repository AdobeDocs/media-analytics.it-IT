...
La lunghezza dell&#39;annuncio è impostata dal lettore a ogni evento `media.adStart`.
...
Ogni elemento rappresenta il valore letterale della lunghezza dell&#39;annuncio, in secondi, riportato il `media.adStart`.
