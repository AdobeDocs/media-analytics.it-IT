...
In Customer Journey Analytics, `mediaReporting.qoeDataDetails.stallTime` può essere utilizzato come metrica o come dimensione senza un componente dimensione separato.
...
| Customer Journey Analytics | [`mediaReporting.qoeDataDetails.stallTime`](https://experienceleague.adobe.com/it/docs/experience-platform/xdm/data-types/qoe-data-details-reporting) |
