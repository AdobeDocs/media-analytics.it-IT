...
Il backend multimediale imposta `mediaReporting.sessionDetails.hasPauseImpactedStreams = true` la prima volta che un evento `media.pauseStart` viene ricevuto durante la sessione. La metrica viene segnalata nella chiamata di chiusura.
