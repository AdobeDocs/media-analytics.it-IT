...
| Tempo trascorso dei contenuti | Evento <br> Tipo: Contatore | Definisci il tuo evento. |
| Avvio video | Evento <br> Tipo: Contatore | Definisci il tuo evento. |
| Completamento video | Evento <br> Tipo: Contatore | Definisci il tuo evento. |
