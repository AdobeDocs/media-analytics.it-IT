...
Se Media Analytics è il percorso desiderato, consulta [Implementazione di Media SDK](/help/implementation/media-sdk-overview.md) e [Media Collection API.](/help/implementation/media-collection-api/mc-api-overview.md)
