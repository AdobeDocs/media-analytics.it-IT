...
Utilizzare `MEDIA_VideoMetadataKeyFEED` per impostare il tipo di feed multimediale nei metadati standard dell&#39;oggetto multimediale prima di chiamare `mediaTrackSessionStart`:
