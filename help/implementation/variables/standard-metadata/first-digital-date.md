...
| **Campo raccolta XDM** | [`xdm.mediaCollection.sessionDetails.firstDigitalDate`](https://experienceleague.adobe.com/it/docs/experience-platform/xdm/data-types/session-details-collection) |
...
Imposta `firstDigitalDate` all&#39;interno di `xdm.mediaCollection.sessionDetails` quando chiama [`sendEvent`](https://experienceleague.adobe.com/it/docs/experience-platform/collection/js/commands/sendevent/overview):
...
Utilizzare `ADBMobile.media.VideoMetadataKeys.FIRST_DIGITAL_DATE` per impostare la prima data digitale nella proprietà `StandardMediaMetadata` dell&#39;oggetto multimediale prima di chiamare `trackSessionStart`:
...
Utilizzare `MEDIA_VideoMetadataKeyFIRST_DIGITAL_DATE` per impostare la prima data digitale nei metadati standard dell&#39;oggetto multimediale prima di chiamare `mediaTrackSessionStart`:
