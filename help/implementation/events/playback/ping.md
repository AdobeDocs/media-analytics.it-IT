...
Media SDK invia automaticamente gli eventi ping, purché si chiami `processMediaMessages` nel ciclo eventi. Aggiorna la testina di riproduzione in modo che ogni ping riporti la posizione corrente:
