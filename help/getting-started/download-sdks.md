...
| ![Icona JavaScript ](assets/javascript-icon.png)</br>**API JavaScript** | <p>Adobe Analytics</p><p>Customer Journey Analytics</p><p>Adobe Journey Optimizer</p><p>Real-Time CDP</p> | Edge | Web - Experienci Platform Edge (disponibile a breve) |  | [Installare Media Analytics con Experienci Platform Edge](/help/implementation/edge/implementation-edge.md) | |
