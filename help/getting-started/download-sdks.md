...
| </br>**Web** | Adobe Analytics<p>Customer Journey Analytics</p><p>Adobe Journey Optimizer</p><p>Real-Time CDP</p> | Edge | Web - Experience Platform Edge |  | [Implementa la raccolta di file multimediali in streaming utilizzando l&#39;Edge Network](/help/implementation/edge/implementation-edge.md) <p>e</p><p>[Inviare dati Web ad Edge con Adobe Experience Platform Web SDK](/help/implementation/edge/edge-web-sdk.md)</p> | |
