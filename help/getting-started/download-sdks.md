...
| [![Icona estensione](assets/plug.svg)](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/client/web-sdk/overview.html?lang=it)<br>[Estensione tag Web SDK](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/client/web-sdk/overview.html?lang=it) | [Configurare l&#39;estensione tag Web SDK per Streaming Media](/help/implementation/edge/web-sdk-tags.md) | [Esempio](https://github.com/adobe/alloy-samples/blob/main/media-collection/TAGS_IMPL.md) |
...
| [![Icona Roku](assets/roku-icon.png)](https://github.com/adobe/aepsdk-roku)<br>[Roku Edge SDK](https://github.com/adobe/aepsdk-roku) | [Configura Roku Edge per Streaming Media](/help/implementation/edge/roku.md) | [Esempio](https://github.com/adobe/aepsdk-roku/tree/main/sample/simple-videoplayer-channel) |
...
| [![Icona Roku](assets/roku-icon.png)](https://github.com/Adobe-Marketing-Cloud/media-sdks/releases/tag/roku-v2.2.7)<br>[SDK Roku 2.x](https://github.com/Adobe-Marketing-Cloud/media-sdks/releases/tag/roku-v2.2.7) | [Configura Roku 2.x per Streaming Media](/help/implementation/analytics-only/roku-2x.md) | [Esempio](https://github.com/Adobe-Marketing-Cloud/media-sdks/tree/master/sdks/roku/samples) |
| [![Icona API](assets/api.png)](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/)<br>[API Media Collection](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/) | [Configura API Media Collection](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/implementation) | |
