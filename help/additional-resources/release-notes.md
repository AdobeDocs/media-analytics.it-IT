...
Per informazioni sulle nuove funzioni, sulle correzioni e sulle informazioni importanti per gli amministratori, consulta le risorse seguenti.
...
## Funzioni nuove e aggiornate di Adobe Customer Journey Analytics per Streaming Media {#cja-features}
...
## Funzioni nuove e aggiornate di Adobe Analytics per Streaming Media {#sm-features}

| Funzione | Descrizione | Data prevista |
| ----------- | ---------- | ------- |
| Tracciamento dello stato di un lettore multiplo | Utilizza l’API Media Collection per implementare il tracciamento dello stato di più lettori. [Ulteriori informazioni](https://experienceleague.adobe.com/docs/media-analytics/using/player-state-tracking/multiple-player-states.html) | Settembre 2022 |
| Campi XDM rinominati | Nomi di campo XDM rinominati per coerenza:<br>* Parametri audio e video<br>* Parametri annuncio<br>* Parametri capitolo<br>* Parametri dello stato del lettore<br>* Parametri di qualità | Settembre 2022 |
| Riferimento Device Co-op | È stato rimosso il riferimento a Adobe Experience Cloud Device Co-op e ai requisiti del servizio Experience Cloud ID. | Agosto 2022 |
| Nomi di campo e percorsi XDM aggiornati per la raccolta e il reporting | È stato aggiornato quanto segue:<br>* Parametri audio e video<br>* Parametri annuncio<br>* Parametri capitolo<br>* Parametri dello stato del lettore<br>* Parametri di qualità | Agosto 2022 |
...
| Tempo trascorso su contenuti multimediali | Scopri in che modo il pannello Tempo di riproduzione dei contenuti multimediali consente agli utenti dei contenuti multimediali di comprendere i propri spettatori in base al tempo di visualizzazione durante il giorno secondo una granularità scelta. <br>[Pannello tempo di riproduzione multimediale (esercitazione)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/media-analytics/measuring-media-analytics/media-playback-time-spent-panel.html?lang=it) | Gennaio 2022 |


## *Note sulle versioni precedenti*

| Funzione | Descrizione | Data di destinazione o aggiornamento |
| ----------- | ---------- | -------------- |
