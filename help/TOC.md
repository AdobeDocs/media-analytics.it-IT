...
+ SDK di Media Analytics {#sdk-implement}
   ...
   + Tracciare la riproduzione di contenuti multimediali in streaming {#track-av-playback}
      ...
      + Tracciare la riproduzione di contenuti multimediali Core in streaming {#track-core}
         ...
         + [Tracciare la riproduzione di base in Chromecast](sdk-implement/track-av-playback/track-core/track-core-chromecast.md)
         + [Tracciare la riproduzione di base in Roku](sdk-implement/track-av-playback/track-core/track-core-roku.md)
   ...
   + Tracciare gli annunci {#track-ads}
      ...
      + [Tracciare gli annunci in Roku](sdk-implement/track-ads/track-ads-roku.md)
   ...
   + Guida di riferimento dettagliata {#cookbook}
      ...
      + [Risoluzione di main:play tra annunci](sdk-implement/cookbook/fix-ad-play-ad.md)
...
+ Reporting e analisi {#media-reports}
   ...
   + [Pannello Pubblico medio per minuto](media-reports/media-workspace-panels/average-minute-audience.md)
   ...
   + [Modelli di Area di lavoro per file multimediali](media-reports/media-workspace-templates.md)
...
+ Tracciare lo stato del lettore {#player-state-tracking}
   ...
   + [Tracciamento di più stati del lettore](sdk-implement/player-state-tracking/multiple-player-states.md)
...
+ Risorse aggiuntive {#additional-resources}
   + [Note sulla versione](additional-resources/release-notes.md)
